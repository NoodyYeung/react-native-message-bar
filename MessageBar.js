...
class MessageBar extends Component {
  ...
  */
  showMessageBarAlert () {
    ...
    if (
      this.alertShown ||
      (this.state.title == null && this.state.message == null && this.props.title == null && this.props.message == null) 
    ) {
      return;
    }
  ...
  */
    ...
    return (
      <Animated.View
        style={[{
          ...
          borderColor: this.props.strokeColor || this.state.strokeColor,
          borderBottomWidth: 1,
          position: 'absolute',
  ...
  renderImage () {
    if (this.props.avatar != null || this.state.avatar != null) {
      var imageSource
      var avatar = this.props.avatar || this.state.avatar;
      ...
      if (typeof avatar === 'string') {
        ...
        return <Image source={imageSource} style={this.props.avatarStyle || this.state.avatarStyle} />
  ...
  renderTitle () {
    if (this.props.title != null || this.state.title != null) {
      return (
        <Text
  ...
  renderMessage () {
    if (this.props.message != null || this.state.message != null) {
      return (
        <Text
